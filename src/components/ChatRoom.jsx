...
const ChatRoom = () => {
    ...
    return (
        <div className="row d-flex justify-content-center ">
            <div className="py-4 m-5 w-50 shadow bg-inherit text-dark border rounded container">
                <div className="text-center px-3 mb-4 text-capitalize">
                    <h1 className="text-primary mb-4">
                        {data?.room}{" "}
                        <span className="text-info">Chat Room</span>
                    </h1>
                </div>
                <div
                    className="bg-inherit border rounded p-3 mb-4"
